...
function Contact() {
  ...
  return (
    <div
      ...
      style={{ minHeight: "100vh", backgroundColor: "#2d2d32", color: "white" }}
    >
      <EventNavbar />
      <div className="container py-5">
        ...
        <div className="row justify-content-center align-items-start">
          ...
          <div
            ...
            style={{ borderLeft: "1px solid white", minHeight: "50vh" }}
          ></div>
          <div className="col-md-4">
            <Form
              ...
              onSubmit={(e) =>
                sendEmail(
                  e,
                  (e.currentTarget.name as unknown as HTMLInputElement).value,
