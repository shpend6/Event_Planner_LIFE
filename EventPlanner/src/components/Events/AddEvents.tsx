...
// Function to handle form submission
    const handleSubmit = async (e : React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const eventData = { organization , title, description, state, starttime, endtime, location, maxcapacity, imagefile, categoryid};           
    ...
    const addevent = async (eventData: { organization: string; title: string; description: string; state: string; starttime: string;
         endtime: string; location: string, maxcapacity: string; imagefile: string; categoryid: string; }) => {
            try {
    ...
    return (
        <Container fluid className="d-flex justify-content-center align-items-center" >
            <Form onSubmit={handleSubmit} className="p-4 rounded shadow border border-white" >
